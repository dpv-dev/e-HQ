// Internal icon set — line icons (24×24 viewBox, stroke-based) with path data from
// Lucide (ISC license, lucide.dev). Embedded here instead of a dependency so the
// composite-TS build stays clean and the set stays curated. Stroke width is a prop
// (1 / 1.5 / 2) per the design-system reference.
...
export const iconNames: readonly IconName[] = Object.keys(iconPaths) as IconName[];
