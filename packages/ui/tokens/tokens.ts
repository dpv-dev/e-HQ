...
export const tokens = {
  ...
  font: {
    body: "'Calibri','Carlito','Segoe UI',-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif",
    display: "'Calibri','Carlito','Segoe UI',-apple-system,BlinkMacSystemFont,sans-serif",
    ...
    size: {
      ...
      action: "11px",
      label: "10px",
      pageTitle: "clamp(24px,2.6vw,34px)",
    },
    line: { ui: "1.5", pageTitle: "1" },
    weight: { display: "600", heading: "500", body: "400", label: "400", figure: "400" },
    roleColor: {
      heading: "var(--ehq-text-secondary)",
      label: "var(--ehq-text-muted)",
      pageTitle: "var(--ehq-yellow)",
    },
  },
