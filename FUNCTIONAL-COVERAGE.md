...
| Statements | `App.svelte` | `/statements`, generate/print/void | Distribution statements | OK | Live-verified 2026-07-20: lifecycle counts show draft, locked-due (`posted`), paid, and voided declarations. Each active row exposes immutable detail lines, exact-decimal CSV, A4 print, and an audited reversal with a mandatory reason. Void declarations remain visible as `void` and cannot be voided again; legacy destructive delete is intentionally excluded. |
