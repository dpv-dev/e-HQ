...
| Statements | `App.svelte` | `/statements`, generate/print/void | Distribution statements | OK (release-ready) | Lifecycle counts show draft, locked-due (`posted`), paid, and voided declarations. Each row opens immutable detail lines, exports exact-decimal CSV, prints A4, or opens an audited reversal with a mandatory reason. Void declarations remain visible as `void`; legacy destructive delete is intentionally excluded. Production deploy/route QA remains pending. |
